    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col-md-8 order-2 order-md-1 align-self-center p-static">
                <h1>- Industrial Relation</h1>
                <span class="d-block text-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
            </div>
            <div class="col-md-4 order-1 order-md-2 align-self-center">
                <ul class="breadcrumb d-block text-md-right breadcrumb-light">
                    <li><a href="datona-hr-consulting .html">Home</a></li>
                    <li><a href="datona-hr-consulting-expertise.html">Expertise</a></li>
                    <li class="active">Industrial Relation</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="row pt-1 pb-4 mb-3">
        ...
        <div class="col-lg-4">
            <img src="{{asset('img/iricon.jpg')}}" class="img-fluid mb-4" alt="">
        </div>
    </div>
</div>
